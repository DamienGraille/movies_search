...
class App extends Component {
  ...
  performSearch(){
    ...
    const urlString = "https://api.themoviedb.org/3/search/movie?api_key=930694ba1ece0a22257165acb5d7eb1b&language=en-US&query=avengers&page=1&include_adult=false"
  $.ajax({
    url: urlString,
